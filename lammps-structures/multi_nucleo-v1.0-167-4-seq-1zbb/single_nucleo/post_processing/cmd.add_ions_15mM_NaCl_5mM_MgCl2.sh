...
python place_ions_15mM_NaCl_5mM_MgCl2.py $num_NA NA_ION.txt -100.0 -300.0 -200.0 35.0 $chainID_sta $resid_sta $num_existing_atoms 35 1.0
...
python place_ions_15mM_NaCl_5mM_MgCl2.py $num_MG MG_ION.txt -96.0 -296.0 -196.0 35.0 $chainID_sta $resid_sta $num_existing_atoms 36 2.0
...
python place_ions_15mM_NaCl_5mM_MgCl2.py $num_CL CL_ION.txt -93.0 -293.0 -193.0 35.0 $chainID_sta $resid_sta $num_existing_atoms 37 -1.0
