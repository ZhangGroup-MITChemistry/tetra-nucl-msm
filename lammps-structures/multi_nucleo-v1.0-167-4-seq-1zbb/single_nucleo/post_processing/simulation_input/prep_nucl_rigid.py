...
n_nucl = 4 # the total number of nucleosomes
nrl = 167 # the nucleosomal repeat length (if n_nucl = 1 then nrl can be any value, should not affect the output)
...
with open('group_rigid.txt', 'w') as output_file:
    for i in range(n_nucl):
